...
<!--<![endif]-->
    <head>
        ...
        <?php
            ...
            echo $this->Html->meta("icon", "img/icono1.png");
        ?>
        ...
        <div class="header navbar navbar-inverse navbar-fixed-top">
            <div class="header-inner">
                <a class="navbar-brand" href="<?php echo $this->Html->url(array(
                    "controller" => "Pages",
                    "action" => "display", "home"
                )); ?>" style="font-size: 1.2em;color: #ffffff;padding-left:5px">
                ...
                <a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <?php echo $this->Html->image("responsive/menu-toggler.png") ?>
                </a>
                <ul class="nav navbar-nav pull-right">           
                    <?php echo $this->element("manage_usuario"); ?>
                </ul>        
            </div>    
        </div>
        ...
        <div class="page-container">
            <div class="page-sidebar navbar-collapse collapse">
                <ul class="page-sidebar-menu">
                    ...
                    <li>&nbsp;</li>
                    <li class="start <?php echo $this->request->params['controller'] == 'Pages' &&
                        $this->request->params["action"] == "display" ? 'active' : ''; 
                    ?>">
                    ...
                    <li class="<?php echo $this->request->params['controller'] == 'Departamentos' &&
                        $this->request->params["action"] == "index_map" ? 'active' : ''; 
                    ?>">
                        <a href="<?php echo $this->Html->url(array(
                            ...
                            <span class="title">Mapa Perú</span>
                            <?php if($this->request->params['controller'] == 'Departamentos' &&
                                $this->request->params["action"] == "index_map") { ?>
                            <span class="selected"></span>
                            <?php } ?>
                        </a>
                    </li>
                    <li  class="<?php echo $this->request->params["controller"] == "Departamentos" && 
                        $this->request->params["action"] == "view_map" ? "open" : ''; 
                    ?>">
                        <a href="javascript:;">
                            <i class="icon-flag"></i>
                        ...
                        <?php echo $this->element("menu_departamentos"); ?>
                    </li>
                    <li  class="<?php echo $this->request->params["controller"] == "Provincias" && 
                        $this->request->params["action"] == "view_map" ? "open" : ''; 
                    ?>">
                        <a href="javascript:;">
                            <i class="icon-flag"></i> 
                        ...
                        <?php echo $this->element("menu_provincias"); ?>
                    </li>
                    <li class="<?php echo ($this->request->params["controller"] == "Departamentos" && 
                        $this->request->params["action"] != "view_map" &&
                        $this->request->params["action"] != "index_map") ||    
                        ($this->request->params["controller"] == "Provincias" && 
                        $this->request->params["action"] != "view_map") ||
                        ($this->request->params["controller"] == "Urds") ||
                        ($this->request->params["controller"] == "Odfs")
                    ? "open" : ""; ?>">
                        <a href="javascript:;">
                        ...
                        <ul class="sub-menu"<?php echo ($this->request->params["controller"] == "Departamentos" && 
                            $this->request->params["action"] != "view_map" &&
                            $this->request->params["action"] != "index_map") ||    
                            ($this->request->params["controller"] == "Provincias" && 
                            $this->request->params["action"] != "view_map") ||
                        ...
                        ? "style='display: block'" : ""; ?>>
                            ...
                            <li class="<?php echo $this->request->params["controller"] == "Urds"        
                            ? "active" : ""; ?>">
                                <a href="<?php echo $this->Html->url(array(
                                    "controller" => "Urds",
                                    "action" => "index"
                            ...
                            <li class="<?php echo $this->request->params["controller"] == "Odfs"        
                            ? "active" : ""; ?>">
                                <a href="<?php echo $this->Html->url(array(
                                    "controller" => "Odfs",
                                    "action" => "index"
